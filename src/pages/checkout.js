...
import e from 'cors';
const Checkout = ({Amount,startTime,endTime,globalpincode,globaldelivery}) => {
...
//////starting time
var datasstart = await axios.get(`https://lms.shop-template.de/data2.php`)
.then(res => res.data)
//console.log(wooFoods)
 datasstart=JSON.stringify(datasstart)
 datasstart=JSON.parse(datasstart)

 var days = ['sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday'];
 var today = new Date();
 var dayName = days[today.getDay()];
 
const searchTerm1 = 'woofood_delivery_hours_'+dayName+'_start";s:';
const indexOfFirst1 = datasstart.indexOf(searchTerm1);
const lengths1=indexOfFirst1+(searchTerm1.length)+4;
var startTime="";
for(var i=indexOfFirst1;i<=lengths1;i++)
{
  startTime=startTime+datasstart[i];
}
...
/////endtime
var datasend = await axios.get(`https://lms.shop-template.de/data2.php`)
.then(res => res.data)
//console.log(wooFoods)
...
const searchTerm2 = 'woofood_delivery_hours_'+dayName+'_end";s:';
const indexOfFirst2 = datasend.indexOf(searchTerm2);
const lengths2=indexOfFirst2+(searchTerm2.length)+4;
var endTime="";
for(var i=indexOfFirst2;i<=lengths2;i++)
{
endTime=endTime+datasend[i];
}
